<template>
    <el-card style="margin: 15px; min-height: calc(100vh - 80px)">
        ...
        <!-- 下部-->
        <div style="display: flex;    width: 100%;    margin-top: 40px;    flex-wrap: wrap;    flex-direction: row;">
            <!--   左侧 宿舍通告-->
            <div style="margin-right: 5%">
                  <Notice :activities="activities"/>
            </div>
            <!--中部-->
            <div style="height: 588px">
                <span style="font-size: 22px;display: block;margin-bottom: 30px;margin-left: 10px;">宿舍学生人数分布</span>
                <home_echarts/>
            </div>
            <!--右侧-->
